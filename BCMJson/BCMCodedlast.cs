...
namespace BCMJson
{
    ...
    [DataSource("DataBase", "Microsoft.VisualStudio.TestTools.DataSource.CSV",
        "|DataDirectory|\\parameters.csv", Microsoft.VisualStudio.TestTools.WebTesting.DataBindingAccessMethod.Random,
    ...
    [DataSource("DataBase1", "Microsoft.VisualStudio.TestTools.DataSource.CSV",
        "|DataDirectory|\\CredentialsTenant.csv", Microsoft.VisualStudio.TestTools.WebTesting.DataBindingAccessMethod.Sequential,
        Microsoft.VisualStudio.TestTools.WebTesting.DataBindingSelectColumns.SelectOnlyBoundColumns, "CredentialsTenant#csv")]

    [DataBinding("DataBase", "parameters#csv", "user", "DataBase.parameters#csv.user")]
    ...
    public class BCMCodedlast : WebTest
    {
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            if (LastResponse.ResponseUri.ToString().Contains("login"))
            {
                ...
                EnterLogin.QueryStringParameters.Add("login", Context["DataBase.parameters#csv.user"].ToString());
                ...
                Login3Body.FormPostParameters.Add("login", Context["DataBase.parameters#csv.user"].ToString());
                ...
                AuthenticationBody.FormPostParameters.Add("wresult",
                    Context["$HIDDENLoginHiddenfields.wresult"].ToString());
            ...
            BeginTransaction("Load Home Page");
            ...
            {
                CurrentUser = JObject.Parse(LastResponse.BodyString);
                CurrentName = (string) (CurrentUser["FirstName"]);
                CurrentdId = (string) (CurrentUser["ContactId"]);
            }
            ...
            JArray contactsArray = null;
            string rndcontacts = null;
            if (LastResponse.StatusCode == HttpStatusCode.OK)
            {
                contactsArray = JArray.Parse(LastResponse.BodyString);
                rndcontacts = (string) contactsArray[0]["FirstName"];
            }

            EndTransaction("Load Home Page");
            ...
            WebTestRequest ContactInfoAfrerSetupDate = new WebTestRequest((Context["WebServer1"] + "/api/Contacts/" + Context["contact_id"]));
            ContactInfoAfrerSetupDate.DependentRequests.Add(new WebTestRequest((Context["WebServer1"] + "/api/Companies/GetCompanyLookupModels/")));
            ContactInfoAfrerSetupDate.DependentRequests.Add(new WebTestRequest((Context["WebServer1"] + "/api/Contacts/GetContactLookupModels/")));
            WebTestRequest ContactInfoAfrerSetupDateDepend1 = new WebTestRequest((Context["WebServer1"] + "/api/Notes/GetByContactId"));
            ContactInfoAfrerSetupDateDepend1.QueryStringParameters.Add("contactId", Context["contact_id"].ToString());
            ContactInfoAfrerSetupDate.DependentRequests.Add(ContactInfoAfrerSetupDateDepend1);
            WebTestRequest ContactInfoAfrerSetupDateDepend2 = new WebTestRequest((Context["WebServer1"] + "/api/Deals/GetOpenDealsAsDealInfo"));
            ContactInfoAfrerSetupDateDepend2.QueryStringParameters.Add("contactId", Context["contact_id"].ToString());
            ContactInfoAfrerSetupDate.DependentRequests.Add(ContactInfoAfrerSetupDateDepend2);
            WebTestRequest ContactInfoAfrerSetupDateDepend3 = new WebTestRequest((Context["WebServer1"] + "/api/Tasks/GetUpcomingTasksByContactId"));
            ContactInfoAfrerSetupDateDepend3.QueryStringParameters.Add("contactId", Context["contact_id"].ToString());
            ContactInfoAfrerSetupDate.DependentRequests.Add(ContactInfoAfrerSetupDateDepend3);
            yield return ContactInfoAfrerSetupDate;
            ...
            AddNoteBody.BodyString = "{\"Content\":\"" + Context["DataBase.parameters#csv.note"] +
                                         "\",\"ContactId\":\"" + Context["contact_id"] + "\"}";
            AddNote.Body = AddNoteBody;
            AddNote.IgnoreHttpStatusCode = true;
            ...
            if (Context.ContainsKey("foundContact"))
            {
                ...
                JObject CurrentFoundSearch = null;
                string foundUserName = null;
                if (LastResponse.StatusCode == HttpStatusCode.OK)
                {
                    CurrentFoundSearch = JObject.Parse(LastResponse.BodyString);
                    foundUserName = (string) CurrentFoundSearch["FirstName"];
                }
                ...
                JObject modify2 = null;
                if (CurrentName != null || CurrentdId != null || foundUserName != null)
                {
                    ...
                    AddPhoneBody.BodyString = "{\"FromName\":\"" + CurrentName + "\",\"ToName\":\"" + foundUserName +
                                              "\",\"From\":\"" + CurrentdId + "\"" +
                                              ",\"To\":\"" + Context["foundContact"] +
                                              "\",\"CallType\":true,\"Description\":\"" +
                                              Context["DataBase.parameters#csv.phone"]
                    ...
                    if (LastResponse.StatusCode == HttpStatusCode.OK)
                    {
                        modify2 = JObject.Parse(LastResponse.BodyString);
                ...
                AddNewTaskBody.BodyString = "{\"RelatedEntityType\":0,\"ContactId\":\"" + Context["foundContact"] +
                                            "\",\"Subjec" +
            ...
            JArray dealsArray = null;
            string rnddeals = null;
            if (LastResponse.StatusCode == HttpStatusCode.OK)
              {
                 dealsArray = JArray.Parse(LastResponse.BodyString);
                 rnddeals = (string) dealsArray[rand.Next(dealsArray.Count)]["Title"];
              }
            ...
            if (LastResponse.StatusDescription.Contains("NotFound") == false && LastResponse.StatusDescription.Contains("TooManyResults") == false)
            {
                if (Context.ContainsKey("searchDeal"))
                {
                    ...
                    JObject modify3 = null;
                    if (LastResponse.StatusCode == HttpStatusCode.OK)
                    {
                        modify3 = JObject.Parse(LastResponse.BodyString);
                    ...
                    AddDocumentBody.FormPostParameters.Add(new FileUploadParameter("file", Context["DataBase.parameters#csv.doc"].ToString(), "application/vnd.openxmlformats-officedocument.wordprocessingml.document", true));
                ...
                if (Context.ContainsKey("anotherDeal"))
                {
                    ...
                    string EstimateRevenue = null;
                    if (LastResponse.StatusCode == HttpStatusCode.OK)
                    {
                         Deal = JObject.Parse(LastResponse.BodyString);
                         compareStatus = (string) Deal["Status"];
                         DealName = (string) Deal["Name"];
                         EstimateRevenue = (string) Deal["EstimatedRevenue"];
                    }
                    ...
                    if (Deal != null)
                    {
                        if (compareStatus.Equals("Open"))
                        {
                            ...
                            DealToWonOrLostBody.BodyString = "{\"Id\":\"" + Context["anotherDeal"] +
                                                             "\",\"DealName\":\"" +
                                                             DealName + "\",\"ActualReven" +
                                                             "ue\":" + EstimateRevenue +
                                                             ",\"ActualCloseDate\":{\"Year\":2014,\"Month\":8,\"Date\":17},\"TotalAmount\":" +
                                                             EstimateRevenue + ",\"Statu" +
                                                             "s\":1}";
            ...
            JArray companies = null;
            string companyId = null;
            string companyName = null;
                if (LastResponse.StatusCode == HttpStatusCode.OK)
                {
                    companies = JArray.Parse(LastResponse.BodyString);
            ...
            EndTransaction("Navigate to the companies");
                ...
                if (companyId != null)
                {
                    ...
                    WebTestRequest OpenCompanyFromList =
                        new WebTestRequest((Context["WebServer1"] + "/api/Companies/" + companyId));
                    OpenCompanyFromList.ThinkTime = 20;

                    WebTestRequest OpenCompanyFromListDepend1 =
                        new WebTestRequest((Context["WebServer1"] + "/api/Contacts/GetContactLookupModels/"));
            ...
            if (Context.ContainsKey("task"))
            {
                ...
                if (companyName != null)
                {
                    ...
                    CreateNewDealBody.BodyString =
                        @"{""EstimatedCloseDate"":{""Date"":17,""Month"":8,""Year"":2014},""ActualCloseDate"":null,""ReadyToBuyStatus"":1,
                        ""Probability"":2,""Contact"":{""Id"":"""",""Name"":"""",""FirstName"":"""",""LastName"":"""",
                        ""PhotoUrl"":null,""Company"":"""",""JobTitle"":"""",""Phone"":"""",""Email"":""""},""Company"":{""Id"":""" +
                        companyId + @""",
                       ""Name"":""" + companyName + @""",""PrimaryContact"":""""},""Status"":1,""ActualRevenue"":15,
                       ""EstimatedRevenue"":""" + Context["DataBase.parameters#csv.EstimatedRevenue"] +
                        @""",""BudgetAmount"":0,""DiscountAmount"":0,
                       ""TotalAmount"":0,""Name"":""" + Context["DataBase.parameters#csv.newDeal"] +
                        @""",""CustomerNeed"":""money""}";
